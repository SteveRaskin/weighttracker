...
"Users": [
{
	...
	"goal weight": "Herbie's goal is 105",
	"peak weight": "Herbie's peak is 205",
	"low weight": "Herbie's low"
},
*/
							//console.log(usersArray[user]["weigh-in data"]); // CRUCIAL ... actually this ain't gonna work; now weigh-ins data is not the same structure
			...
			function ajaxPost(){
				...
				*/
				...
				request.open('POST', "process_INSERT_data.php", true);
